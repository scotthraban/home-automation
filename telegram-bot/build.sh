...
podman manifest rm telegram-bot:6.0
podman rmi telegram-bot:6.0
podman build --platform linux/amd64,linux/arm64 --manifest telegram-bot:6.0 .
podman manifest push telegram-bot:6.0 docker-registry.hraban.com/telegram-bot:6.0
